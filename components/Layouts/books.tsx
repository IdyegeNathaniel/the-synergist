...
const Books: React.FC = () => {
  return (
    <section className="w-full min-h-screen bg-main py-20 text-light">
      <div className="max-w-7xl w-full flex flex-col md:flex-row gap-5 items-center mx-auto py-4 px-6 md:px-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-3">
          <h2 className="text-lg md:text-2xl text-primary font-semibold leading-relaxed ">REINTRODUCTION TO MONEY</h2>
